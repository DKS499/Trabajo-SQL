...
DELETE FROM "azafatos" CASCADE;
DELETE FROM "embarcar" CASCADE;
DELETE FROM "vuelos" CASCADE;
DELETE FROM "piloto" CASCADE;
DELETE FROM "empleados" CASCADE;
DELETE FROM "pasajeros" CASCADE;
DELETE FROM "lugar" CASCADE;
